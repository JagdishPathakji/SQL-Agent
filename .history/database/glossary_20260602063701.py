# Upgraded Business Glossary & Column Descriptions with SQL Few-Shot Prompting
...
BUSINESS_GLOSSARY = {
    ...
    "instructors": (
        ...
        "SQL: SELECT i.* FROM instructors i JOIN departments d ON i.dept_id = d.dept_id WHERE i.status = 'Active' AND d.code = 'CS';"
    ),
    "courses": (
    ...
    "classrooms": (
        ...
        "SQL: SELECT * FROM classrooms WHERE room_type = 'Lab' AND capacity > 30;"
    ),
    "sections": (
    ...
    "transactions": (
        ...
        "SQL: SELECT * FROM transactions WHERE payment_method = 'Credit Card';"
    ),
    "scholarships": (
